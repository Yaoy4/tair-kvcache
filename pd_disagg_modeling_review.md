...
> **Status note (post-v1.7 fixes):** This is the historical review that
...
> batches, a shared capacity-accounted KV link, strict phase guards,
> `queue_end`-gated prefill timing, and SGLang-driven EOS/stop/abort cleanup.
> The findings below describe the pre-fix implementation. The single native
> SGLang batch-composition loop remains an explicit simulation architecture
> boundary; Backend B uses predictor workers rather than two real SGLang
> scheduler services.
